...
INSERT INTO `pages` VALUES (1,'Home','Welcome to my content management system'),(2,'About','A content management system is an application used to manage web content, allowing multiple contributors(administrators) to create, update and delete content.'),(3,'Contact','If you have any questions, please contact us.');
